...
def add_vocabs(vocabs: List[Path], mappings: dict):
    for vocab in vocabs:
        r = httpx.post(
            "http://fuseki.surroundaustralia.com/ggic-vocabs/data",
...
def remove_vocabs(vocabs: List[Path], mappings: dict):
    for vocab in vocabs:
        r = httpx.post(
            "http://fuseki.surroundaustralia.com/ggic-vocabs/update",
...
if __name__ == "__main__":
    ...
    r = httpx.get("http://ggic.surroundaustralia.com/cache-reload")
